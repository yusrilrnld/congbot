...
@poci_cmd(pattern="ucp(?: |$)(.*)")
async def _(typeq):
    if typeq.chat_id in DEVS:
        return await edit_or_reply(typeq, "LAH DIA DEVELOPER USERBOT TOLOL")
